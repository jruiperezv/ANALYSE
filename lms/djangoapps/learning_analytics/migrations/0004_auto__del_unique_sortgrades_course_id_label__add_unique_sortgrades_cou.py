...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SortGrades', fields ['course_id', 'label']
        db.delete_unique('learning_analytics_sortgrades', ['course_id', 'label'])

        # Adding unique constraint on 'SortGrades', fields ['course_id', 'sort_type', 'label']
        db.create_unique('learning_analytics_sortgrades', ['course_id', 'sort_type', 'label'])


    def backwards(self, orm):
        # Removing unique constraint on 'SortGrades', fields ['course_id', 'sort_type', 'label']
        db.delete_unique('learning_analytics_sortgrades', ['course_id', 'sort_type', 'label'])

        # Adding unique constraint on 'SortGrades', fields ['course_id', 'label']
        db.create_unique('learning_analytics_sortgrades', ['course_id', 'label'])
